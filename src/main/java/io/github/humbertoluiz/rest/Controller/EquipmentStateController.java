...
public class EquipmentStateController {
	...
	@ResponseStatus(HttpStatus.CREATED)
	public void update(@RequestBody @Valid EquipmentState equipmentState, @PathVariable UUID equipmentStateId) {
		equipmentStateService.update(equipmentStateId, equipmentState);
	}
