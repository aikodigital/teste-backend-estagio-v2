...
public class EquipmentModelStateHourlyEarningsServiceImpl implements EquipmentModelStateHourlyEarningsService {
    ...
    @Override
    @Transactional
    public EquipmentModelStateHourlyEarnings save( EquipmentModelStateHourlyEarningsDTO equipmentModelStateHourlyEarningsDTO ) {
    /*-----------------------------------------------------------------------------------------*/    	
	...
	public Optional<EquipmentModelStateHourlyEarnings> getById(UUID equipmentModelStateHourlyEarningsId) {
		...
		Optional<EquipmentModelStateHourlyEarnings> equipmentModelStateHourlyEarnings = Optional.ofNullable(equipmentModelStateHourlyEarningsRepository.findById(equipmentModelStateHourlyEarningsId)
			.orElseThrow(() ->
			new ResponseStatusException(HttpStatus.NOT_FOUND, "EquipmentModelStateHourlyEarnings não encontrado")));
	...
	@Override
	@Transactional
	public void update(UUID equipmentModelStateHourlyEarningsId) {
	...
	public void delete(UUID equipmentModelStateHourlyEarningsId) {
		...
		equipmentModelStateHourlyEarningsRepository
		.findById(equipmentModelStateHourlyEarningsId)
		.map( equipmentModelStateHourlyEarnings -> {
